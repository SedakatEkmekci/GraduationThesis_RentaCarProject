...
<form class="row g-4 needs-validation" novalidate>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="validationCustom03" placeholder="Renter Age"
                                    required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control" id="validationCustom05" required>
                                <div class="invalid-feedback">
                                    Looks good!
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="datetime-local" class="form-control" id="validationCustom06" required>
                                <div class="invalid-feedback">
                                    Looks good!
                                </div>
                            </div>
